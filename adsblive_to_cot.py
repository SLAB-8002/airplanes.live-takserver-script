...
MIL_COT_RULES = [
    ...
    {"t": "B1",  "cot": "a-f-A-M-F-B"},
    {"t": "B52",  "cot": "a-f-A-M-F-B"},
    {"t": "B742", "desc_has": ["E-4B"], "cot": "a-f-A-M-F-D"},
    {"t": "B762", "desc_has": ["KC-46"], "cot": "a-f-A-M-F-K"},
    {"t": "C130", "cot": "a-f-A-M-F-C"},
    {"t": "C150", "cot": "a-f-A-M-F-T"},
    {"t": "C17",  "cot": "a-f-A-M-F-C"},
    {"t": "C172", "cot": "a-f-A-M-F-T"},
    {"t": "C2", "cot": "a-f-A-M-F-C"},
    {"t": "C27J", "cot": "a-f-A-M-F-C"},
    {"t": "C30J", "desc_has": ["KC-130"], "cot": "a-f-A-M-F-K"},
    ...
    {"t": "CN35", "cot": "a-f-A-M-F-H"},
    {"t": "D328", "desc_has": ["C-146"], "cot": "a-f-A-M-F-M"},
    {"t": "E2", "cot": "a-f-A-M-F-R-W"},
    {"t": "E3TF", "cot": "a-f-A-M-F-R-W"},
    {"t": "E6", "cot": "a-f-A-M-F-D"},
    {"t": "F5", "ownop_has": ["Marine Corps"], "cot": "a-h-A-M-F-F"},
    {"t": "GLEX", "desc_has": ["E-11"], "cot": "a-f-A-M-F-Y"},
    {"t": "GLF5", "desc_has": ["EA-37"], "cot": "a-f-A-M-F-J"},
    {"t": "HAWK", "desc_has": ["T-45"], "cot": "a-f-A-M-F-T"},
    {"t": "K35R", "cot": "a-f-A-M-F-K"},
    {"t": "P3", "cot": "a-f-A-M-F-P"},
    {"t": "P8", "cot": "a-f-A-M-F-P"},
    {"t": "PC12", "desc_has": ["U-28"], "cot": "a-f-A-M-F-R-Z"},
    {"t": "R135", "cot": "a-f-A-M-F-R"},
    {"t": "SR20", "cot": "a-f-A-M-F-T"},
    {"t": "T34T", "cot": "a-f-A-M-F-T"},
    {"t": "T38", "cot": "a-f-A-M-F-T"},
    {"t": "TEX2", "desc_has": ["T-6"], "cot": "a-f-A-M-F-T"},

    #Rotary wing
    {"t": "A119", "cot": "a-f-A-M-H-T"},
    ...
    {"t": "H53S",  "desc_had": ["MH-53E"], "cot": "a-f-A-M-H-I"},
    {"t": "H53S",  "desc_had": ["CH-53"], "cot": "a-f-A-M-H-C-H"},
    {"t": "H60",  "desc_has": ["HH-60"], "cot": "a-f-A-M-H-H"},
    {"t": "H60",  "desc_has": ["MH-60R"], "cot": "a-f-A-M-H-S"},
    {"t": "H60",  "desc_has": ["MH-60T"], "cot": "a-f-A-M-H-H"},
    {"t": "H60",  "cot": "a-f-A-M-H-U"},
    {"t": "H64",  "cot": "a-f-A-M-H-A"},
    {"t": "LYNX",  "cot": "a-f-A-M-H-U"},
